...
{/*
    ...
    class IP_address {
        ...
        public string CalculateHostsMaxCount(ComboBoxItem cidr)
        {
            string HostsMaxCount;
            double stepen = 32 - int.Parse(cidr.Content.ToString());
            long HostsMax = (long)Math.Pow(2.0, stepen);
            return HostsMaxCount = String.Format(CultureInfo.InvariantCulture, "{0:#,#}",HostsMax.ToString("#,#", CultureInfo.InvariantCulture));
    ...
    class IP_Mask {
       ...
       // public string subnetMaskBinary;
        ...
        public void CalculateBinarySubnetMask(string submask)
        {

            subnetMaskBinaryChar = submask.ToCharArray();
            ...
            Console.WriteLine(subnetMaskBinaryChar);
            //return subnetMaskBinaryChar;
            
        }
        public void CalculateDecimalMaxOctets()
        {
            ResetValues();
            ...
            Console.WriteLine(firstmaxoctet);
        }
